...
interface EvaluationDescriptionFormProps {
...
export const EvaluationDescriptionForm = ({
  initialData,
  courseId,
  evaluationId,
}: EvaluationDescriptionFormProps) => {
                ...
                <FormItem>
                  <FormControl>
                    <Textarea
                      ...
                      placeholder="e.j. 'Respondé todas las preguntas para aprobar el curso.'"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
